...
<body>
    ...
    <section class="header">
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                    <a href="index"><img src="{{('website/assets/images/logo_main.png')}}" class="w-100"></a>
                </div>
                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><a class="dropdown-item" href="calender-dashboard">Planlægnings kalender</a>
                                    </li>
                                    <li><a class="dropdown-item" href="Inspiration-Ideas">Inspiration & Ideer</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="col-md-3">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="login" class="btn w-100 p_btn_head">LOGIN</a>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-4">
                    <a href="index"><img src="webiste/assets/images/logo_main.png" class="w-100"></a>
                </div>
