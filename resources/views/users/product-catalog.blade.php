    ...
    <div class="content">
                ...
                <div class="col-md-6 col-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-9">
                            <h1 class="Calendar" style="font-size: 24px; margin-top: -5px;"> Produktkatalog</h1>
                        </div>
                        <div class="col-md-3 col-1">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="row live">
                    <div class="col-md-4">
                        <h2 class="p-3 Calendar">Produktkatalog</h2>
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <a href="" class="btn btn-primary mt-3 w-100"><img
                                        src="website/user/../assets/images/download8.png"></i>Importer
                                    Produkt</a>
                            </div>
                            <div class="col-md-4">
                                <a href="" class="btn btn-info mt-3 w-100"><img
                                        src="website/user/../assets/images/plus.png"></i>Opret Produkt</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table" style="border: 1px solid #2E32381F;border-radius: 16px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class=" t-heading ps-5">Kampagne</th>
