...
@section('contant')
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-9">
                                <h1 class="Calendar" style="font-size: 32px; margin-top: -5px;">Live Video</h1>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ url('campaigns/post-live-video-post') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="user_id" id="user_id" value="{{ \Auth::user()->id }}">
                        <input type="hidden" name="social_type" id="social_type" value="live">
                        <div class="row">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        ...
                                        <div class="card drag-item cursor-move mb-lg-0 mb-4"
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="pt-5 mt-4">
                                                    <input type="file" class="form-control Ty pe" name="file"
                                                        id="file-input" value="{{ $campaign->files }}" style="height: 10%;"
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 col-lg-12 col-xl-12 table-responsive">
                                    <table class="table table-success"
                                        ...
                                        <thead>
                                            <tr>
                                                <th scope="col" class=" t-heading">Select
                                                </th>
                                                <th scope="col" class=" t-heading">
                                                    Produktnavn</th>
                                                <th scope="col" class=" t-heading ">Pris
                                                </th>
                                                <th scope="col" class=" t-heading">Søgeord
                                                </th>
                                                <th scope="col" class=" t-heading">Lager
                                                </th>
