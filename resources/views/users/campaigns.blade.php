            ...
            <div class="row live">
                ...
                <div class="col-md-8">
                    <div class="row live">
                        ...
                        <div class="col-md-4">
                            <a href="" class="btn btn-info mt-3 w-100"> <i class="fa text-light">&#xf03e;</i>Nyt medie
                                indhold</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-8">
                            <div class=" text-end pt-2 d-flex">
                                ...
                                <input type="text" class="form-control main_form" placeholder="Søg..." name="" style="    border: none;
								width: 160px;
                            ...
                            <table class="table " style="border: 1px solid #2E32381F;border-radius: 16px;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="heading1 pt-3">None</td>
                                        <td class="heading pt-3"><img src="user/image/print.png" style="width: 20px;">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="heading pt-3">Ingen fil</td>
                                        <td class="heading pt-3">Vis Fil</td>
                                        <td class="heading pt-3"><img src="user/image/print.png" style="width: 20px;">
                                        </td>
                                        <td class="heading pt-3"><a href="add-product-info.php"><i class="fa fa-edit"
                                                    style="color:#2E32387A;"></i></a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="heading1 pt-3">Ingen fil</td>
                                        <td class="heading pt-3">Vis Fil</td>
                                        <td class="heading pt-3"><img src="user/image/print.png" style="width: 20px;">
                                        </td>
                                        <td class="heading pt-3"><a href="add-product-info.php"><i class="fa fa-edit"
