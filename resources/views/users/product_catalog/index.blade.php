                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="" class="btn btn-primary mt-3 w-100"><img
                                        src="{{url('website/assets/images/download8.png')}}"></i>Importer
                                    Produkt</a>
                            </div>
                            <div class="col-md-4">
                                <a href="{{url('product-catalog/create')}}" class="btn btn-info mt-3 w-100"><img
                                        src="{{url('website/assets/images/plus.png')}}"></i>Opret Produkt</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table" style="border: 1px solid #2E32381F;border-radius: 16px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class=" t-heading">Creation Date</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="heading pt-3">{{$product->created_at}}</td>
                                            <td class="heading pt-3">{{$product->name}}</td>
                                            <td class="heading pt-3 ps-5 pe-5" style="padding-left:115px !important;">
                                                $412.50</td>
                                            <td class="heading pt-3 pe-5 ps-5">{{$product->product_information}}</td>
                                            <td class="heading ">{{$product->price}}</td>

                                            <td class="heading pt-3 ps-5">
                                                <img src="{{url('website/assets/images/mark.png')}}" style="width: 20px;">
                                            </td>
                                            <td class="heading pt-3">
                                                <a href="{{url('product-catalog/'.$product->id.'/edit')}}" class="btn btn-primary">
                                                <i class="fa fa-edit" style="color:#2E32387A;"></i>
                                            </td>
                                            <td class="heading pt-3">

                                                <form action="{{ route('product-catalog.destroy', $product->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
