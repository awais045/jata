    ...
    <div class="content">
                ...
                <div class="col-md-6 col-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-10">
                            <h1 class="Calendar" style="font-size: 24px; margin-top: -5px;">Sideindstillinger</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row live">
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-md-8">
                        <h2 class="p-3 Calendar calender_mobile">Sideindstillinger</h2>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3" style="border-bottom: 1px solid #2E32381F;">
                            <div class="col-md-9 col-9">
                                <p>
                                    Slet reservation hvis kommentar slettes
                                </p>
                            </div>
                        ...
                        <div class="row mt-3" style="border-bottom: 1px solid #2E32381F;">
                            <div class="col-md-9 col-9">
                                <p class="allow">
                                    Send bekræftelsesbesked ved betaling
                                </p>
                            </div>
                            <div class="col-md-3 col-3 text-end">
                                <div class="form-check form-switch">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="card" style="background: #EEF9FFE5;border: none;border-radius: 10px;">
                                    <div class="card-body" style="padding:10px;">
                                        <label class="ps-2"
                                            style="color: #2E32388F;font-size: 12px !important;">Sprog</label>
