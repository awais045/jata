                ...
                <div class="col-md-6 col-5">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-9">
                            <h1 class="Calendar" style="font-size: 19px;    margin-top: -5px;">Calender</h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="row calender_first">
                        <div class="col-md-5">
                            <h2 class="p-3 Calendar calender_mobile">Calendar</h2>
                        </div>
                        <div class="col-md-7">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <a href="" class="btn btn-primary mt-3 w-100"><img
                                            src="website/user/../assets/images/tag1.PNG"></i> Deal Sale</a>
                                </div>
                                <div class="col-md-4">
                                    <a href="" class="btn btn-info mt-3 w-100"> <i class="fa text-light">&#xf03e;</i>
                                        New Media Post</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row ">
                        <div class="col-md-3 mt-3">
                            <div class="card text-center dashboard_card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 mt-1 col-4">
                                            <img src="website/user/../assets/images/video-icon2.PNG" class="w-100">
                                        </div>
