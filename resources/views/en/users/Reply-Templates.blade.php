    ...
    <div class="content">
                ...
                <div class="col-md-6 col-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-10">
                            <h1 class="Calendar" style="font-size: 24px; margin-top: -5px;">Reply Templates</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="row live">
                    <div class="col-md-8">
                        <h2 class="p-3 Calendar">Reply Templates</h2>
                    </div>
                    <div class="col-md-4">
                                ...
                                <ul class="nav nav-fill nav-tabs" role="tablist"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="fill-tab-1" data-bs-toggle="tab" href="#fill-tabpanel-1"
                                            role="tab" aria-controls="fill-tabpanel-1" aria-selected="false">Sold
                                            Out</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="fill-tab-2" data-bs-toggle="tab" href="#fill-tabpanel-2"
                                            role="tab" aria-controls="fill-tabpanel-2" aria-selected="false"> Advanced
                                            Features, </a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="fill-tab-3" data-bs-toggle="tab" href="#fill-tabpanel-3"
                                            role="tab" aria-controls="fill-tabpanel-3" aria-selected="false"> Sold Out
                                            (Public) </a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="fill-tab-4" data-bs-toggle="tab" href="#fill-tabpanel-4"
                                            role="tab" aria-controls="fill-tabpanel-4" aria-selected="false">Not
                                            Enough</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="fill-tab-5" data-bs-toggle="tab" href="#fill-tabpanel-5"
                                            role="tab" aria-controls="fill-tabpanel-5" aria-selected="false">Messenger
                                            Error</a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="col-md-12">
                                                <div class="heading-bro">
                                                    <p style="color:#2CAAE1;">
                                                        ...
                                                        Here you design your default replies that will be applied to new
                                                        campaigns. After creating anew campaign, you can edit the
                                                        replies for the specific campaign if needed.<i
                                                            class="fa fa-close"
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="reply-border">
                                                                    ...
                                                                    <div class="d-flex justify-content-end">
																		...
																		color: #FF5C37;
																		">Cancel</a>
                                                                        <a href=".php" class="btn btn-info">Save</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-8 col-7">
                                                                <p class="reply">
                                                                    Reply in messenger <span
                                                                        style="color: #2E32388F;">(private)</span>
                                                                </p>
                                                            </div>
