    ...
    <div class="content">
                ...
                <div class="col-md-6 col-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-9">
                            <h1 class="Calendar" style="font-size: 24px; margin-top: -5px;">Product Catalog</h1>
                        </div>
                        <div class="col-md-3 col-1">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="row live">
                    <div class="col-md-5">
                        <h2 class="p-3 Calendar">Product Catalog</h2>
                    </div>
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <a href="" class="btn btn-primary mt-3 w-100"><img
                                        src="website/user/../assets/images/download8.png"></i>Import Product</a>
                            </div>
                            <div class="col-md-4">
                                <a href="" class="btn btn-info mt-3 w-100"><img
                                        src="website/user/../assets/images/plus.png"></i>Create Product</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table" style="border: 1px solid #2E32381F;border-radius: 16px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class=" t-heading">Product Name</th>
                                            <th scope="col" class=" t-heading ps-5"
                                                style="padding-right:66px !important;padding-left: 134px !important;">
                                                Price</th>
                                            <th scope="col" class=" t-heading">Search Term</th>
                                            <th scope="col" class=" t-heading">Inventory</th>
                                            <th scope="col" class=" t-heading ps-5">Compaign</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="heading pt-3">Castor Bulllock</td>
                                            <td class="heading pt-3 ps-5 pe-5" style="padding-left:115px !important;">
                                                $412.50</td>
                                            <td class="heading pt-3 pe-5 ps-5">Quia Ipsum Dolorem</td>
                                            <td class="heading ">92</td>

                                            <td class="heading pt-3 ps-5"><img
                                                    src="website/user/../assets/images/mark.png" style="width: 20px;">
                                            </td>
                                            <td class="heading pt-3"><i class="fa fa-edit" style="color:#2E32387A;"></i>
                                            </td>
                                            <td class="heading pt-3"><i class="fa fa-trash-o"
                                                    style="color: #2E32387A;"></i>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row" class="">
                                            ...
                                            <td class="heading pt-3 ps-5 pe-5" style="padding-left:115px !important;">
                                                $412.50</td>
                                            <td class="heading pt-3 pe-5 ps-5">Quia Ipsum Dolorem</td>
                                            <td class="heading pt-3">78</td>

                                            <td class="heading pt-3 ps-5"><img
                                                    src="website/user/../assets/images/mark.png" style="width: 20px;">
                                            </td>
                                            <td class="heading pt-3"><img src="website/user/../assets/images/mark.png"
                                                    style="width: 20px;"></td>
										...
										">
                                            ...
                                            <td class="heading pt-3 ps-5 pe-5" style="padding-left:115px !important;">
                                                $412.50</td>
                                            <td class="heading pt-3 pe-5 ps-5">Quia Ipsum Dolorem</td>
                                            <td class="heading pt-3 ">92</td>
                                            <td class="heading pt-3 ps-5"><img
                                                    src="website/user/../assets/images/marke1.png" style="width: 30px;">
                                            </td>
                                            <td class="heading pt-3"><img src="website/user/../assets/images/marke1.png"
                                                    style="width: 30px;"></td>
