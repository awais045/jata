    ...
    <div class="content">
                ...
                <div class="col-md-6 col-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-9">
                            <h1 class="Calendar" style="font-size: 24px; margin-top: -5px;">Order</h1>
                        </div>
                        <div class="col-md-3 col-1">
        ...
        <div class="row live">
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-md-5">
                        <h2 class="p-3 Calendar">Orders</h2>
                    </div>
                    <div class="col-md-7">
                        <div class="row">
                                ...
                                <table class="table " style="border: 1px solid #2E32381F;border-radius: 16px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class=" t-heading">Order Number</th>
                                            <th scope="col" class=" t-heading ps-5"
                                                style="padding-right:100px !important;">Customer</th>
                                            <th scope="col" class=" t-heading" style="padding-right:100px !important;">
                                                Basket Date</th>
                                            <th scope="col" class=" t-heading" style="padding-right:100px !important;">
                                                Basket Total</th>
                                            <th scope="col" class=" t-heading "
                                                style="padding-right: 114px !important;">Paid</th>
