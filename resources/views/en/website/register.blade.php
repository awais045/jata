            ...
            <div class="row  pb-5 mb-5 footerrow">
                <div class="col-md-5 mt-5 pt-5">
                    ...
                    <form class="mt-5 pt-3">
                        <input type="email" name="email" placeholder="Full Name" class="form-control w-100">


                        <input type="email" name="email" placeholder="Din Email" class="form-control w-100">

                        <input type="email" name="email" placeholder="Create Password" class="form-control w-100">
                        <div class="custom-password-input">
                            <input type="password" name="Password" placeholder="Repeat Password"
                                class="form-control w-100" id="password-input">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <a href="" class="btn btn-warning w-100 text-center">Create an Account</a>
